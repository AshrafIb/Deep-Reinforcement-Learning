# This Agent is an alternated Version, of the official DDPG-Udacity-Agent. 
# https://github.com/udacity/deep-reinforcement-learning/blob/master/ddpg-pendulum/ddpg_agent.py.
# And is based on my own Implementation 
# https://github.com/AshrafIb/Deep-Reinforcement-Learning/blob/master/Project%20Control/agent_2.py
...
# Function "Steps" is excluded, as it is implemented in the MADDPG         
    ...
    #def step(self, state, action, reward, next_state, done, times):
        ...
        # Create several trajectory's for each agent in Num Agent. 
        
        #for agent in range(self.number_agents):
            #self.memory.add(state[agent], action[agent], reward[agent], next_state[agent], done)
